...
class PomodoroTimer extends React.Component {
    ...
    elapseTime() {
        ...
        if ((this.state.timeElapsed) == 0) { //when timer gets to 0
            alert(this.msg);
    ...
    render() {
        return (
            <div>This timer runs for {this.props.workingTime} minutes, followed by a rest of {this.props.restTime} minutes.
            For a total of {this.totalTime(this.props.workingTime, this.props.restTime)} minutes.
            <br/>There are {Math.floor(this.state.timeElapsed/60)}:{this.formatSeconds(this.state.timeElapsed%60, 2)} seconds elapsed.</div>
        );
    }
...
ReactDOM.render(
    <PomodoroTimer workingTime={25} restTime={5} />,
